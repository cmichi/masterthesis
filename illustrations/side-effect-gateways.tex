...
\begin{tikzpicture}[node distance=10mm, scale=1]
	...
	% the gateway
	\node (gateway) [roundBox, minimum height = 0.8cm, minimum width = 3.5cm, text width = 5cm, fill = bgcolor2] at (5, 2) {Gateway};

	\node [above = 25mm of c1] (se) {\footnotesize HTTP GET/POST};
